...
# npy_file = r"C:\Users\11093\Desktop\DSEC\zurich_city_09_a\tracks.npy"
# timestamp_file = r"C:\Users\11093\Desktop\DSEC\zurich_city_09_a\images\timestamps.txt"
...
for item in tqdm(data):
    ...
    h = item[4]
    class_id = item[5]
    line_number = find_line_number(timestamp_file, t)
    # 重新分类给标签
    if class_id == 0:
        new_id = 0
    elif class_id == 1:
