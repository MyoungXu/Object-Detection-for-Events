...
def main():
    ...
    parser.add_argument("--s", default="dataset_to_be_detected/images/origin", help="save path")
    args = parser.parse_args()
    image_box_save_dir = args.s

    image_dir = r'dataset_to_be_detected/images/train'  # 图片存储文件夹
    labels_dir = r'dataset_to_be_detected/labels/train'  # 标签存储文件夹
